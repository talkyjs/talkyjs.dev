...
import { StaticCardGrid } from '../templates/StaticCardGrid'
  ...
  return (
    ...
    >
      ...
      <Button.Group size="large">
        <Button href="https://github.com/talkyjs/talkyjs-cli" target="_blank">
          Github
          <GithubOutlined />
        </Button>
        <Button type="primary">
              ...
              <StaticCardGrid
                items={[
                  ...
                  },
                  {
                    ...
                    content: (
                      <>
                        ...
                        <br />
                        We can easy to create handler / router / service with
                        test.
                      </>
                    ),
                  },
                  {
                    ...
                    content: (
                      <>
                        ...
                        <br />
                        It's easy to handle the request denepnds of the
                        situation.
                      </>
                    ),
                  },
                  {
                    ...
                    content: (
                      <>
                        TalkyJS includes a commonly used Handler and
                        interceptors
                        <br />
                        AMAZON.RepeatIntent, ErrorHandler, SessionEndedRequest,
                        and more.
                      </>
                    ),
                  },
